...
export async function getReport(reportId: string): Promise<TrainingReport> {
  ...
  return {
    ...
    videoUrl: fixVideoUrl(r.poseOverlayVideoUrl || r.poseOverlayVideoPath || r.videoPath || r.videoStorageUrl || r.videoUrl || ''),
    poseOverlayVideoUrl: fixVideoUrl(r.poseOverlayVideoUrl || r.poseOverlayVideoPath || ''),
